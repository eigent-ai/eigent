...
export default function Tasks() {
    ...
    return (
        <ReactFlowProvider>
            <div className="flex-1 min-w-0 min-h-0 flex h-full items-center justify-center bg-surface-secondary border-solid border-border-tertiary rounded-2xl gap-2 relative overflow-hidden">
                <ResizablePanelGroup direction="horizontal" key={isChatBoxVisible ? 'with-chat' : 'without-chat'}>
                    {isChatBoxVisible && (
                        <>
