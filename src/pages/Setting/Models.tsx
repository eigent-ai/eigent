  ...
  return (
    <div className="flex flex-col gap-4 pb-40">
      {import.meta.env.VITE_USE_LOCAL_PROXY !== 'true' && (
        <div className="bg-panel-gradient inline-flex w-full flex-col items-start justify-start gap-4 self-stretch rounded-2xl border-solid border-border-disabled px-6 py-4 pt-4">
