...
type CloudModelType = 'gemini-3-pro-preview' | 'gemini-3-flash-preview' | 'gpt-4.1-mini' | 'gpt-4.1' | 'claude-sonnet-4-5' | 'claude-sonnet-4-20250514' | 'gpt-5' | 'gpt-5.1' | 'gpt-5.2' | 'gpt-5-mini';
