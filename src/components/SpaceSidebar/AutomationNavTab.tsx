...
export function automationListenerLeadIconClass(
...
export interface AutomationReconnectButtonProps {
  wsConnectionStatus: WebSocketConnectionStatus;
  onReconnect: () => void;
}

/** Reconnect button for the Automations tab — direct click, no dropdown. */
export function AutomationReconnectButton({
  wsConnectionStatus,
  onReconnect,
}: AutomationReconnectButtonProps) {
