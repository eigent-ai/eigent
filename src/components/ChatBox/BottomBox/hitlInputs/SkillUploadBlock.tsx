...
interface Props {
  block: Extract<HitlInputBlock, { kind: 'skill_upload' }>;
  value: unknown;
  onChange: (v: unknown) => void;
  disabled?: boolean;
}

export const SkillUploadBlock: React.FC<Props> = ({
  block,
  onChange: _onChange,
  disabled,
}) => {
  ...
  return (
    <div className="gap-1 flex w-full flex-col">
      ...
      <Button
        ...
        disabled={disabled}
        onClick={() =>
          navigate('/history?tab=agents&section=skills&skillAction=upload')
        }
