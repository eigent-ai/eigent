...
interface Props {
  block: Extract<HitlInputBlock, { kind: 'model' }>;
  value: string;
  onChange: (v: string) => void;
  disabled?: boolean;
}

export const ModelPickerBlock: React.FC<Props> = ({
  block,
  value,
  onChange: _onChange,
  disabled,
  ...
  const handleOpen = () => {
    // Navigate to model configuration; the user configures and comes back.
