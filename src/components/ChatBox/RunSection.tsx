...
export const RunSection = React.forwardRef<HTMLDivElement, RunSectionProps>(
  (
    {
      chatId,
      chatStore,
    ...
    return (
      ...
      >
        ...
        {/* Floating Action Button - positioned at Run level */}
        {activeTaskId && (
          <FloatingAction
            status={task.status}
...
RunSection.displayName = 'RunSection';
