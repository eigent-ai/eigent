...
interface EventNativeWorkSessionTimelineProps {
 ...
 */
export function EventNativeWorkSessionTimeline({
  chatStore,
  ...
  scrollContainerRef,
  scrollBottomInsetPx,
}: EventNativeWorkSessionTimelineProps) {
...
export type { EventNativeWorkSessionTimelineProps };
