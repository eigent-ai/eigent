...
import { groupMessagesByQuery, RunSection } from './RunSection';

interface WorkSessionChatContainerProps {
  className?: string;
...
export const WorkSessionChatContainer: React.FC<
  WorkSessionChatContainerProps
> = ({
  className = '',
  scrollContainerRef,
  scrollBottomInsetPx,
