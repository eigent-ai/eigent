...
import { UserMessageRichContent } from '@/components/ChatBox/messages/UserMessageRichContent';
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-[600px] flex-col">
        <div className="min-h-0 rounded-2xl border-ds-border-neutral-subtle-disabled bg-ds-bg-splitting-subtle-default flex h-full flex-col overflow-hidden border border-solid">
          <div className="gap-2 px-3 pt-2 flex shrink-0 items-center">
            <div className="min-w-0 text-body-sm font-bold text-ds-text-neutral-default-default flex-1">
          ...
          <div className="scrollbar scrollbar-always-visible min-h-0 border-ds-border-neutral-subtle-disabled px-2 flex-1 overflow-x-hidden overflow-y-auto border border-x-0 border-t-1 border-b-0 border-solid bg-transparent">
            {hasTaskInfo ? (
              <SubtaskEditor
                taskInfo={taskInfo}
                onAdd={onAddTask}
                ...
                {streamingTasks.tasks.map((content, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="min-w-0 text-label-xs text-ds-text-neutral-default-default flex-1">
                        {content}
                      </span>
                    </div>
                  );
