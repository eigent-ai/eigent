...
>(({ onShowEnvConfig, onSelectedToolsChange, initialSelectedTools }, ref) => {
  ...
  const addOptionRef = useRef<(item: McpItem, isLocal?: boolean) => void>(
    null!
  );
                  ...
                  onInstall = async () => {
                    try {
                      ...
                      if (response.success) {
                        ...
                        addOptionRef.current?.(notionItem, true);
                      } else {
                        console.error(
                  ...
                  onInstall = async () => {
                    try {
                      ...
                      if (response.success) {
                        ...
                        addOptionRef.current?.(calendarItem, true);
  ...
  addOptionRef.current = addOption;
  ...
  useEffect(() => {
    ...
    fetchIntegrationsData();
    fetchInstalledMcps();
  }, [fetchData, fetchIntegrationsData]);
  ...
  }, [keyword, fetchIntegrationsData, fetchData]);
