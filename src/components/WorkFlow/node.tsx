                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col items-start justify-center">
                      ...
                      {task?.status === 'running' && (
                        <div className="duration-400 mt-xs flex flex-col gap-1 animate-in fade-in-0 slide-in-from-bottom-2">
                          {/* Streaming agent output */}
                          {chatStore.tasks[chatStore.activeTaskId as string]
                            ?.streamingAgentOutput?.[task.id] && (
                            <div className="min-w-0 flex-1 overflow-hidden text-xs leading-normal text-text-secondary duration-200 animate-in fade-in-0">
