...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.List
		ref={ref}
		className={cn(
			"inline-flex items-center justify-center bg-muted p-1 text-muted-foreground !h-[32px] bg-menutabs-bg-default rounded-md border border-solid border-menutabs-border-default",
			className,
		)}
		{...props}
	/>
