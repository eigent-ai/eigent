	...
	"inline-flex items-center justify-center whitespace-nowrap transition-all duration-200 ease-in-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20  aria-invalid:border-destructive",
	{
		variants: {
			variant: {
				...
				success:
					"bg-button-fill-success text-button-fill-success-foreground font-bold rounded-xs shadow-[0px_0px_0px_1px_rgba(212,212,212,0.25)] shadow-[0px_3px_4px_-1px_rgba(0,0,0,0.25)] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.33)] hover:bg-fill-fill-success-hover active:bg-fill-fill-success-active focus:bg-fill-fill-success-hover focus:ring-2 focus:ring-gray-4 focus:ring-offset-2 cursor-pointer",
				cuation:
					"bg-button-fill-cuation text-button-fill-cuation-foreground font-bold rounded-xs shadow-[0px_0px_0px_1px_rgba(212,212,212,0.25)] shadow-[0px_3px_4px_-1px_rgba(0,0,0,0.25)] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.33)] focus:ring-2 focus:ring-gray-4 focus:ring-offset-2 cursor-pointer",
				information:
					"bg-button-fill-information text-button-fill-information-foreground font-bold rounded-xs shadow-[0px_0px_0px_1px_rgba(212,212,212,0.25)] shadow-[0px_3px_4px_-1px_rgba(0,0,0,0.25)] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.33)] focus:ring-2 focus:ring-gray-4 focus:ring-offset-2 cursor-pointer",
				warning:
					"bg-button-fill-warning text-button-fill-warning-foreground font-bold rounded-xs shadow-[0px_0px_0px_1px_rgba(212,212,212,0.25)] shadow-[0px_3px_4px_-1px_rgba(0,0,0,0.25)] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.33)] focus:ring-2 focus:ring-gray-4 focus:ring-offset-2 cursor-pointer",
				},
			size: {
				xxs: "inline-flex justify-start items-center gap-1 px-1 py-0.5 rounded-md text-[10px] font-bold leading-17 [&_svg]:size-16",
