...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'focus:text-accent-foreground relative flex cursor-default select-none items-center gap-2 rounded-lg bg-menubutton-fill-default px-2 py-1.5 text-sm outline-none transition-colors focus:bg-menubutton-fill-active data-[disabled]:pointer-events-none data-[highlighted]:bg-menubutton-fill-hover data-[disabled]:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0',
      inset && 'pl-8',
      className
    )}
    {...props}
