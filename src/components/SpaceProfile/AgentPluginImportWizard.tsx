    ...
    return (
      <Card className="mx-auto w-full max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            {conversion.slug} version {conversion.version} is a local Space
            profile draft. It has not been published or imported elsewhere.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button onClick={openSpaceSettings}>Review Space settings</Button>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="mx-auto w-full max-w-4xl space-y-5">
        ...
        <>
          ...
          <header>
            ...
            <p className="mt-2 max-w-2xl text-body-sm text-ds-text-neutral-muted-default">
              ...
              before converting it to a local Space profile draft.
            </p>
          </header>
        </>
      ) : null}
      ...
      <Card className={showHeader ? undefined : 'space-y-3 !border-0'}>
        <CardHeader className={showHeader ? undefined : '!p-0'}>
          ...
          <CardDescription>
            ...
            inspected locally and is never included in the converted Space
            profile.
          </CardDescription>
        </CardHeader>
        <CardContent
      ...
      {inspection ? (
        <>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Convert to Space profile</CardTitle>
              <CardDescription>
                Conversion is local and does not publish or import the Space
                profile.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {targetMode === 'existing' && selectableSpaces.length === 0 ? (
                <p className="text-body-sm text-ds-text-warning-default-default">
                  Create a Space before converting this Agent Plugin.
                </p>
              ) : null}
              ...
              {replacementReview ? (
                <div className="space-y-3 rounded-xl border border-ds-border-warning-default-default bg-ds-bg-warning-subtle-default p-4 text-body-sm">
                  <div>
                    <strong>Replace the existing Space profile draft?</strong>
                    <p className="mt-1 text-body-xs">
                      {replacementReview.targetName} already has saved Space
                      profile settings (draft version{' '}
                      {replacementReview.version}). Agent Plugin conversion
                      replaces that working draft; it does not merge settings.
                      The current Space remains active until you publish and
                  ...
                  <label className="flex items-start gap-3">
                    <Checkbox
                      ...
                      aria-label="Confirm replacing existing Space profile draft"
                    />
