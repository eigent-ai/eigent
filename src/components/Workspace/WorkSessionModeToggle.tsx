...
export interface WorkSessionModeToggleProps {
   ...
   * Work Session chat input. Uses a transparent background to match the chat
   * input bar (see model read-only chip).
   */
  readOnly?: boolean;
...
export function WorkSessionModeToggle({
  value,
  onValueChange,
  className,
  readOnly = false,
  compact = false,
}: WorkSessionModeToggleProps) {
