...
export function SpaceSwitchDropdown({
  ...
  const triggerNode = openOnHover ? (
    <div className={triggerWrapperClassName} onMouseEnter={openFromHover}>
      <DropdownMenuTrigger asChild>{hoverOpenTrigger}</DropdownMenuTrigger>
    </div>
  ) : (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <DropdownMenuSeparator className="bg-ds-border-neutral-default-default my-0" />

        <div className={cn('px-1 pt-1 mb-1')}>
          <DropdownMenuSub>
