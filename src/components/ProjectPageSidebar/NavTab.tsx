...
export function workspaceTabButtonClass(active: boolean): string {
  return cn(
    ...
    'hover:bg-ds-bg-neutral-default-default focus-visible:ring-ds-ring-neutral-default-default focus-visible:ring-2 focus-visible:outline-none',
    active && 'bg-ds-bg-neutral-default-default'
  );
}
