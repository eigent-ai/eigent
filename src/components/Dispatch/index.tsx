...
export function WorkspaceDispatch() {
  ...
  return (
    <div className="min-h-0 flex h-full w-full flex-col overflow-hidden">
      {/* Header */}
      <div className="gap-2 border-ds-border-neutral-subtle-default px-3 box-border flex h-[45.5px] w-full shrink-0 items-center border-x-0 border-t-0 border-b border-solid">
