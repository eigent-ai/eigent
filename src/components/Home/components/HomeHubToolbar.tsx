...
export default function HomeHubToolbar({
  ...
  return (
    <div
      ref={toolbarRef}
      className="sticky top-[var(--home-hub-history-tabs-offset,49px)] z-10 flex w-full flex-wrap items-center justify-between gap-3 bg-ds-bg-neutral-muted-default px-2 py-4"
    >
