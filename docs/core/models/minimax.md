...
- **Get your API Key:** If you haven't already, generate a key at [Minimax Platform](https://www.minimax.io/).
...
**3. Enter API Details** Click on the Minimax Config card and fill in the following fields:
...
- Once saved, the **"Set as Default"** button on the Minimax Config card will be selected/active.
