...
class SingleAgentWorker(BaseSingleAgentWorker):
    ...
    async def _process_task(
        ...
        async with PerfTimer("_process_task", **perf_context):
            logger.info(
            ...
            # We use a list to keep history of attempts if retries happen
