...
class TestFormatRawError:
    """Test cases for format_raw_error function."""
    ...
    def test_format_error_with_default_max_length(self):
...
class TestCategorizeError:
    ...
    def test_model_processing_error_401(self):
    ...
    def test_model_processing_error_404(self):
    ...
    def test_model_processing_error_429(self):
    ...
    def test_model_processing_error_quota(self):
    ...
    def test_http_status_code_429(self):
...
class TestCreateAgent:
    ...
    def test_create_agent_success(self, mock_chat_agent, mock_model_factory):
...
@pytest.mark.unit
class TestValidateModelWithDetails:
    """Test cases for validate_model_with_details function."""
    ...
    def test_validation_missing_model_platform(self):
    ...
    @patch("app.component.model_validation.ModelFactory.create")
    def test_validation_model_creation_failure(self, mock_model_factory):
        """Test validation when model creation fails."""
        mock_model_factory.side_effect = ModelProcessingError(
            "401 Unauthorized"
        )
    ...
    def test_validation_agent_creation_failure(
        self, mock_chat_agent, mock_model_factory
    ):
    ...
    @patch("app.component.model_validation.ModelFactory.create")
    @patch("app.component.model_validation.ChatAgent")
    def test_validation_model_call_failure(
        self, mock_chat_agent, mock_model_factory
    ):
    ...
    @patch("app.component.model_validation.ModelFactory.create")
    @patch("app.component.model_validation.ChatAgent")
    def test_validation_no_tool_calls(
        self, mock_chat_agent, mock_model_factory
    ):
    ...
    @patch("app.component.model_validation.ModelFactory.create")
    @patch("app.component.model_validation.ChatAgent")
    def test_validation_diagnostic_info(
        self, mock_chat_agent, mock_model_factory
    ):
