...
export function ThemeSettings() {
  ...
  return (
    <div className="space-y-4 rounded-xl border border-ds-border-neutral-subtle-disabled bg-ds-bg-neutral-default-default p-4">
      <div>
      ...
      <div>
        <label className="mb-2 block text-body-sm font-medium text-ds-text-neutral-default-default">
