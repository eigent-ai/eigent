...
export function ProfileManageSection() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[640px] flex-col gap-4">
      <section className="rounded-xl border border-solid border-ds-border-neutral-subtle-default bg-ds-bg-neutral-default-default p-4">
        <h2 className="mb-4 text-heading-sm font-semibold text-ds-text-neutral-default-default">
          Account
        </h2>
        <div className="space-y-4">
          <div>
            <label className="mb-1 block text-body-sm font-medium">Email</label>
      ...
      <section className="rounded-xl border border-solid border-ds-border-neutral-subtle-default bg-ds-bg-neutral-default-default p-4">
        ...
        <dl className="grid grid-cols-2 gap-3 text-body-sm">
          ...
          <div>
            ...
            <dd className="font-medium capitalize text-ds-text-neutral-default-default">
