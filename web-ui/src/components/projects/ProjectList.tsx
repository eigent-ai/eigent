...
export function ProjectList({
  ...
  if (loading) {
    return (
      <div className="rounded-xl border border-ds-border-neutral-subtle-disabled bg-ds-bg-neutral-subtle-default p-8 text-center text-ds-text-neutral-muted-default">
        Loading projects…
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="rounded-xl border border-ds-border-error-subtle-default bg-ds-bg-error-subtle-default p-8 text-center text-ds-text-error-default-default">
        {error}
      </div>
    );
  }
  ...
  if (projects.length === 0) {
    ...
    if (hasUnfilteredProjects && trimmedSearch) {
      return (
        <div className="px-2 py-8 text-center text-ds-text-neutral-muted-default">
    ...
    return (
      <div className="rounded-xl border border-dashed border-ds-border-neutral-subtle-disabled bg-ds-bg-neutral-subtle-default p-10 text-center">
        <FolderOpen className="mx-auto mb-3 h-10 w-10 text-ds-icon-neutral-muted-default" />
