    ...
    <div className="flex h-full w-full flex-col overflow-y-auto">
      <div className="flex-1">
        <div className="relative mb-4 max-w-xl">
          <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-ds-icon-neutral-muted-default" />
          <Input
            value={search}
      ...
      <div className="sticky bottom-0 z-10 flex justify-center px-4 py-4">
        <Button
          variant="primary"
          size="md"
          buttonContent="text"
