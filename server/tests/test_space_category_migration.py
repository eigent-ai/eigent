...
def test_space_category_migration_extends_current_merged_head(server_root: Path):
    migration = server_root / "alembic/versions/2026_09_20_1200-add_space_category_key.py"
    ...
    assert 'sa.Column("category_key", sa.String(length=50), nullable=True)' in source
