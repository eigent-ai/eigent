...
Revision ID: 2025_11_27_1106-add_trigger_tables
Revises: add_timestamp_to_chat_step
Create Date: 2025-11-27 11:06:00.000000
...
revision: str = "2025_11_27_1106-add_trigger_tables"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("listener_type", sa.String(length=50), nullable=True),
        ...
        sa.Column("task_prompt", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column("custom_task", sa.JSON(), nullable=True),
