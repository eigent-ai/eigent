...
class ScheduleTriggerConfig(BaseTriggerConfig):
    ...
    @classmethod
    def validate_expiration_date_format(cls, v: str | None) -> str | None:
    ...
    def is_expired(self, check_date: datetime | None = None) -> bool:
        ...
        if self.date:
            execution_date = datetime.strptime(self.date, "%Y-%m-%d").replace(hour=23, minute=59, second=59, tzinfo=UTC)
    ...
    def should_execute(self, check_date: datetime | None = None) -> tuple[bool, str]:
        """
